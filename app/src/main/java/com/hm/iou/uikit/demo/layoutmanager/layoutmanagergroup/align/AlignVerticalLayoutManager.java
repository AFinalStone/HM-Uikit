...
public class AlignVerticalLayoutManager extends LinearLayoutManager {
    private static final String TAG = "AlignVerticalLayoutManager";
    private VerticalSnapHelper mPagerSnapHelper;
    private OnAlignLayoutManagerListener mOnAlignLayoutManagerListener;
    private RecyclerView mRecyclerView;
    private int mDrift;//位移，用来判断移动方向

    public AlignVerticalLayoutManager(Context context) {
        super(context, LinearLayoutManager.VERTICAL, false);
        init();
    }

    public AlignVerticalLayoutManager(Context context, boolean reverseLayout) {
        super(context, LinearLayoutManager.VERTICAL, reverseLayout);
        init();
    }

    private void init() {
        mPagerSnapHelper = new VerticalSnapHelper();
    }
