 ...
 */
public class HMKeyboardView extends KeyboardView {
    ...
    public HMKeyboardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0, 0);
    }

    public HMKeyboardView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, 0);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public HMKeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (null == getKeyboard() || !(getKeyboard() instanceof BaseKey) || null == ((BaseKey) getKeyboard()).getKeyStyle()) {
            Log.e(TAG, "");
            super.onDraw(canvas);
            return;
        }
