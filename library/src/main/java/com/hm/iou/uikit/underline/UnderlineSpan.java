package com.hm.iou.uikit.underline;
...
public class UnderlineSpan extends DynamicDrawableSpan {
    ...
    public UnderlineSpan(int lineHeight, TextPaint textPaint, String text,
                         int underlineColor) {
