...
public class WheelPicker extends View {
    ...
    private OnWheelChangeListener<IPickerItem> mOnWheelChangeListener;
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        mTextColor = a.getColor(R.styleable.WheelPicker_itemTextColor, 0xff9b9b9b);
        ...
        mSelectedItemTextColor = a.getColor(R.styleable.WheelPicker_selectedTextColor, 0xff111111);
        ...
        mCurtainBorderColor = a.getColor(R.styleable.WheelPicker_wheelCurtainBorderColor, 0xffe6e6e6);
    ...
    public void computeTextSize() {
        ...
        if (!TextUtils.isEmpty(mItemMaximumWidthText)) {
            ...
            mTextMaxWidth = (int) mPaint.measureText(mDataList.get(0).getItemName());
        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int drawDataPos = drawnSelectedPos - mHalfVisibleItemCount - 1;
            ...
            IPickerItem data = mDataList.get(position);
            ...
            String drawText = mDataFormat == null ? data.getItemName() : mDataFormat.format(data.getItemName());
            //在中间位置的Item作为被选中的。
    ...
    public void setOnWheelChangeListener(OnWheelChangeListener<IPickerItem> onWheelChangeListener) {
    ...
    public List<IPickerItem> getDataList() {
        return mDataList;
    }

    public void setDataList(@NonNull List<IPickerItem> dataList) {
        mDataList = dataList;
        if (dataList.size() == 0) {
            return;
        }
