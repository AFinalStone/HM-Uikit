...
//
	...
	// Wheel drawables
	private int wheelBackground = R.drawable.uikit_wheel_bg;
	private int wheelForeground = R.drawable.uikit_wheel_val;
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.uikit_wheel_line_border));
		// 设置线宽
