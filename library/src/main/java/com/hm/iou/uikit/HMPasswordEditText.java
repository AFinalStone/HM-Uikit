 ...
 * 密码框
 * @author syl
 * @time 2018/5/19 下午7:03
 */
public class HMPasswordEditText extends TextInputEditText {


    private final static int EXTRA_TAPPABLE_AREA = 50;

    @DrawableRes
    private int showPwIcon = R.mipmap.uikit_icon_password_eye_open;

    @DrawableRes
    private int hidePwIcon = R.mipmap.uikit_icon_password_eye_close;
    ...
    public HMPasswordEditText(Context context) {
        this(context, null);
    }

    public HMPasswordEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        initFields(attrs, 0);
    }

    public HMPasswordEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initFields(AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            TypedArray styledAttributes = getContext().getTheme().obtainStyledAttributes(attrs, R.styleable.HMPasswordEditText, defStyleAttr, 0);
            try {
                showPwIcon = styledAttributes.getResourceId(R.styleable.HMPasswordEditText_iconShow, showPwIcon);
                hidePwIcon = styledAttributes.getResourceId(R.styleable.HMPasswordEditText_iconHide, hidePwIcon);
                hoverShowsPw = styledAttributes.getBoolean(R.styleable.HMPasswordEditText_hoverShowsPw, false);
                useNonMonospaceFont = styledAttributes.getBoolean(R.styleable.HMPasswordEditText_nonMonospaceFont, false);
                disableIconAlpha = styledAttributes.getBoolean(R.styleable.HMPasswordEditText_disableIconAlpha, false);
            } finally {
